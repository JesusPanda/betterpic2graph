(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e,t,n,r){return{x:e-n/2,y:r/2-t}}function t(e){return Number(e.toFixed(3)).toString()}function n(n,r,i){let a=[];if(!n||!n.layers)return a;for(let o of n.layers){let n=o.paths||o;if(Array.isArray(n)){for(let o of n)if(!(!o||!o.segments))for(let n=0;n<o.segments.length;n++){let s=o.segments[n],c=s.x3,l=s.y3,u=e(c,l,r,i);if(s.type===`L`){let n=e(s.x4,s.y4,r,i),o=n.x-u.x,c=n.y-u.y;if(Math.abs(c)<.001){let e=Math.min(u.x,n.x),r=Math.max(u.x,n.x);a.push(`y=${t(u.y)} \\left\\{ ${t(e)} \\le x \\le ${t(r)} \\right\\}`)}else if(Math.abs(o)<.001){let e=Math.min(u.y,n.y),r=Math.max(u.y,n.y);a.push(`x=${t(u.x)} \\left\\{ ${t(e)} \\le y \\le ${t(r)} \\right\\}`)}else{let e=`(${t(u.x)} + t*${t(o)}, ${t(u.y)} + t*${t(c)})`;a.push(e)}}else if(s.type===`Q`){if(s.x5===void 0||s.y5===void 0)continue;let n=e(s.x4,s.y4,r,i),o=e(s.x5,s.y5,r,i),c=`(1-t)^2*${t(u.x)} + 2(1-t)t*${t(n.x)} + t^2*${t(o.x)}`,l=`(1-t)^2*${t(u.y)} + 2(1-t)t*${t(n.y)} + t^2*${t(o.y)}`;a.push(`(${c}, ${l})`)}}}}return a}var r=`
  <header>
    <h1>Pic2Graph</h1>
